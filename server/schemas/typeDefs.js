...
const typeDefs = gql`
  ...
  type BarInfo {
    ...
    venue_name_1: String
    venue_add_1: String
    venue_rating_1: Float
    venue_name_2: String
    venue_add_2: String
    venue_rating_2: Float
    venue_name_3: String
    venue_add_3: String
  ...
  type Section {
    menu_1_loc_section: String
    menu_2_loc_section: String
    menu_3_loc_section: String
  }
  ...
  type InsidePark {
    ...
    name_display_long: String
    menu_1: String
    menu_1_loc_name: [String]
    menu_1_loc_section: [String]
    menu_1_image: String
    menu_2: String
    menu_2_loc_name: [String]
    menu_2_loc_section: [String]
    menu_2_image: String
    menu_3: String
    menu_3_loc_name: [String]
    menu_3_loc_section: [String]
    menu_3_image: String
  }
